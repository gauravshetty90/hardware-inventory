...
1. Finish the sales tab shell in the UI.
2. Add a `Sale` model and `SalesService`.
3. Persist sales in a separate data file from products.
4. Make sale recording reduce inventory quantity automatically.
